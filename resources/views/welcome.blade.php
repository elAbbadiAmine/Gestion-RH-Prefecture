...
@media (min-width: 641px) {
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
							<a href="#">
                            <img class="header-logo-image" src="{{URL::asset('img/prov.png')}}" alt="Logo">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Application de gestion des ressources humaines</h1>
    ...
    height: 48px;
    text-align: center;
    white-space: nowrap" href="{{ url('/home') }}">Accueil</a>
                    @else
                        <a style="text-decoration: none !important;
    text-transform: uppercase;
    background-color: #353935;
    ...
    height: 48px;
    text-align: center;
    white-space: nowrap" href="{{ route('login') }}">Connexion</a>
                        <a style="text-decoration: none !important;
    text-transform: uppercase;
    ...
    height: 48px;
    text-align: center;
    white-space: nowrap"href="{{ route('register') }}">S'inscrire</a>
                    @endauth
                </div>
            @endif       
						</div>
